      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={isAuthenticated() ?<ImageToVideo /> :  <Navigate to='/login' />}
          />
          <Route
            path='/:id/dashboard/generate/texttovideo'
            element={isAuthenticated() ? <TextToVideo /> :  <Navigate to='/login' />}
          />
          <Route
            path=':id/dashboard/generate/foodexportassistant'
            element={
          ...
          <Route
            path='/:id/dashboard/generate/videomenugeneration'
              ...
              element={isAuthenticated() ? <VideoMenuGen /> :  <Navigate to='/login' />}
          />
        </Routes>
      </BrowserRouter>
  );
