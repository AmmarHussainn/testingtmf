...
//           <img src={process.env.PUBLIC_URL + '/images/productSixMain.png'} />
//         </div>
//       </div>
...
//         </div>
//         <div className='w-[80%] md:w-[40%] px-10'>
//           <img src={process.env.PUBLIC_URL + '/images/menuSecondDiv.png'} />
//         </div>
//       </div>
    ...
    <div>
      ...
      >
        <div className='w-[90%] md:w-[55%] flex flex-col px-0  md:px-10 gap-4 md:gap-8'>
          ...
          <p className='font-poppins text-[16px] md:text-[18px] text-white'>
          Search the market for your exports globally with our market research assistant AI chatbot
          </p>
          <div className='flex gap-7 items-center'>
            <p className='font-poppins text-[14px] md:text-[16px] text-white'>
              Easier
        ...
        <div className='w-[80%] md:w-[40%] px-10'>
          <img src={process.env.PUBLIC_URL + '/images/p6M.png'} />
        </div>
      </div>
      ...
      <div className='bg-[#E9EFFD] py-20 flex items-center flex-col md:flex-row justify-center'>
        <div className='w-[90%] md:w-[50%] flex flex-col px-0  md:px-10 gap-4 md:gap-8'>
          <h1 className='text-[30px] md:text-[48px] font-bold font-poppins '>
          How Our Food Export Assistant Tool Works?
          </h1>
          <p className='font-poppins text-[16px] md:text-[18px] text-justify'>
          Our Food Export Assistant AI Chatbot empowers you to uncover global opportunities for your food exports with precision and ease. Tailored to simplify the export process, this AI-driven chatbot delivers valuable insights into international demand, market trends, and regulatory requirements across different countries. Through an intuitive chat interface, you can access current data, evaluate potential markets, and receive customized recommendations for your export goals. Perfect for food exporters and business strategists, our chatbot transforms complex market research into actionable insights, helping you expand globally with confidence.
          </p>
        </div>
        <div className='w-[80%] md:w-[40%] px-10'>
          <img src={process.env.PUBLIC_URL + '/images/p6bA.png'} />
        </div>
      </div>
